window.onload = () => {
    ...
    gsap.to(".animation-text5-right", {
        scrollTrigger: {
            trigger: ".animation-text5-right",
            start: "top 80%",
            end: "bottom 100%",
            scrub: 0.5,
        },
    ...
    gsap.to(".animation-text6-right", {
        scrollTrigger: {
            trigger: ".animation-text6-right",
            start: "top 80%",
            end: "bottom 100%",
            scrub: 0.5,
        },
    ...
    gsap.to(".animation-icon3-opa", {
        scrollTrigger: {
            trigger: ".animation-icon3-opa",
            start: "top 80%",
            end: "bottom 100%",
            scrub: 0.5,
        },
    ...
    gsap.to(".animation-icon4-opa", {
        scrollTrigger: {
            trigger: ".animation-icon4-opa",
            start: "top 65%",
            end: "bottom 100%",
            scrub: 0.5,
        },
    ...
    gsap.to(".animation-icon5-opa", {
        scrollTrigger: {
            trigger: ".animation-icon5-opa",
            start: "top 50%",
            end: "bottom 100%",
            scrub: 0.5,
        },
    ...
    gsap.to(".animation-icon6-opa", {
        scrollTrigger: {
            trigger: ".animation-icon6-opa",
            start: "top 80%",
            end: "bottom 100%",
            scrub: 0.5,
        },
    ...
    gsap.to(".animation-icon7-opa", {
        scrollTrigger: {
            trigger: ".animation-icon7-opa",
            start: "top 65%",
            end: "bottom 100%",
            scrub: 0.5,
        },
