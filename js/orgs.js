window.onload = () => {
    ...
    gsap.to(".animation-text2-opa", {
        scrollTrigger: {
            trigger: ".animation-text2-opa",
            start: "top 80%",
            end: "bottom 100%",
            scrub: 0.5,
        },
    ...
    gsap.to(".animation-text5-opa", {
        scrollTrigger: {
            trigger: ".animation-text5-opa",
            start: "top 80%",
            end: "bottom 100%",
            scrub: 0.5,
        },
    ...
    gsap.to(".animation-icones-top2", {
        scrollTrigger: {
            trigger: ".animation-icones-top2",
            start: "top 120%",
            end: "bottom 130%",
            scrub: 0.5,
        },
